...
function keys_are_equal($array1, $array2, $array3 = [])
{
    if (!empty($array3)) {
        $remaning = array_diff_key($array1, $array2);
        if(!empty($remaning)){
            return keys_are_equal($remaning, $array3);
        }
...
function http_set_code($code = NULL)
{
